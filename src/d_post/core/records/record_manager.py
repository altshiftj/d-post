...
from d_post.core.config.schema import DeviceConfig
...
from d_post.metrics import FILES_PROCESSED_BY_RECORD
...
class RecordManager:
    ...
    def create_record(
        ...
        Args:
            filename_prefix: Standardized filename prefix (e.g., 'usr-inst-sample123')
    ...
    def sync_records_to_database(self):
        ...
        Processing logic:
        1. Skip non-inst records (institute filter)
