...
from d_post.core.config import ConfigService
from d_post.core.interactions import ErrorMessages
...
from d_post.core.processing.models import ProcessingResult, ProcessingStatus
...
from d_post.core.ui.ui_abstract import UserInterface
from d_post.metrics import (
    EVENTS_PROCESSED,
    EXCEPTIONS_THROWN,
    FILE_PROCESS_TIME,
    FILES_FAILED,
...
class DeviceWatchdogApp:
    ...
    def _process_next_event(self) -> None:
        ...
        try:
            ...
            Exception
        ) as exc:  # noqa: BLE001 - keep broad to surface unexpected errors
