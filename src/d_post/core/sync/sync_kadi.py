...
from d_post.core.config.constants import ID_SEP
from d_post.core.interactions import ErrorMessages, UserInteractionPort
...
class KadiSyncManager(ISyncManager):
    ...
    def _prepare_resources(
        ...
        device_user_id = f"{local_record.device_type}{ID_SEP}usr".replace(
            "_", "-"
        ).lower()
