...
from d_post.core.config import ConfigService, DeviceConfig, get_service
from d_post.core.interactions import UserInteractionPort
from d_post.core.logging.logger import setup_logger
from d_post.core.processing.device_resolver import DeviceResolver
from d_post.core.processing.error_handling import safe_move_to_exception
from d_post.core.processing.file_processor_abstract import (
    FileProcessorABS,
    PreprocessingResult,
    ProcessingOutput,
)
from d_post.core.processing.models import (
    ProcessingCandidate,
    ProcessingRequest,
    ProcessingResult,
    ProcessingStatus,
...
from d_post.core.processing.modified_event_gate import ModifiedEventGate
from d_post.core.processing.notifications import notify_success
from d_post.core.processing.processor_factory import FileProcessorFactory
from d_post.core.processing.record_flow import handle_unappendable_record
from d_post.core.processing.record_utils import (
    apply_device_defaults,
    get_or_create_record,
    update_record,
)
from d_post.core.processing.rename_flow import RenameService
from d_post.core.processing.routing import (
    determine_routing_state,
    fetch_record_for_prefix,
)
from d_post.core.processing.stability_tracker import FileStabilityTracker
from d_post.core.records.record_manager import RecordManager
from d_post.core.session.session_manager import SessionManager
from d_post.core.storage.filesystem_utils import (
    generate_file_id,
    get_record_path,
...
from d_post.metrics import FILES_FAILED, FILES_PROCESSED
...
class _ProcessingPipeline:
    ...
    def _invoke_rename_flow(
        ...
        outcome = manager._rename_service.obtain_valid_prefix(
            current_prefix, contextual_reason
        )
    ...
    def _route_with_prefix(
        ...
        return self._dispatch_route(
            RouteContext(updated, sanitized_prefix, record, decision)
        )
