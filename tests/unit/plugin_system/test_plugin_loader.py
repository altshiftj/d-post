...
from d_post.device_plugins.test_device.plugin import TestDevicePlugin
from d_post.pc_plugins.test_pc.plugin import TestPCPlugin
from d_post.plugin_system import PluginLoader, hookimpl
...
def test_register_device_plugin_via_hook():
    loader = _make_loader()
    module = importlib.import_module("d_post.device_plugins.test_device.plugin")
...
def test_register_pc_plugin_via_hook():
    loader = _make_loader()
    module = importlib.import_module("d_post.pc_plugins.test_pc.plugin")
