...
from d_post.core.config.service import ActiveConfig
...
def pc_config(tmp_path) -> PCConfig:
    ...
    return PCConfig(
        ...
        watcher=WatcherSettings(
            poll_seconds=0.5, max_wait_seconds=10.0, stable_cycles=3
        ),
...
def test_active_config_device_overrides(
    pc_config: PCConfig, device_config: DeviceConfig
) -> None:
