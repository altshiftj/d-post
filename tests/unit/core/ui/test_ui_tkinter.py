...
from d_post.core.interactions import SessionPromptDetails
from d_post.core.interactions.messages import DialogPrompts
...
def test_show_rename_dialog(ui_instance):
    with patch("d_post.core.ui.ui_tkinter.RenameDialog") as MockDialog:
...
def test_run_on_ui_sync_executes_via_after(ui_instance, monkeypatch):
    ...
    monkeypatch.setattr("d_post.core.ui.ui_tkinter.threading.get_ident", lambda: 1)
...
def test_show_done_dialog_requires_callable(ui_instance):
    ...
    with patch("d_post.core.ui.ui_tkinter.tk.Toplevel"), patch(
        "d_post.core.ui.ui_tkinter.tk.Label"
    ), patch("d_post.core.ui.ui_tkinter.tk.Button"):
