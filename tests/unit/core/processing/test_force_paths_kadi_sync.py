...
from d_post.core.processing.file_processor_abstract import ProcessingOutput
...
def test_force_paths_use_force_flag_in_kadi_sync(
    ...
    monkeypatch.setattr("d_post.core.sync.sync_kadi.KadiManager", DummyKadiManager)
