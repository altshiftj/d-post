...
from d_post.core.interactions import RenameDecision, RenamePrompt, SessionPromptDetails
from d_post.core.interactions.ports import UserInteractionPort
...
class HeadlessUI(UserInteractionPort):
    ...
    def prompt_rename(self):
        ...
        return {"name": "test", "institute": "inst", "sample_ID": "sample"}
